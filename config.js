...
module.exports = {
     ...
     */
    botname: process.env.BotName || "AMIR",
    footer: process.env.Footer || "© Powered AMIR",
    ...
    ownernumber: process.env.Owner_Number || "923114397148",
    ...
    packname: process.env.PackName || "Mian Amir",
    socialLink: process.env.Web || "https://github.com",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/C3hvdeFzNGw85epEc0Q56P",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongodb+srv://ukalsom212:q4w8zMTeEFmRYxkG@amir46.kfi6e.mongodb.net/",
    sessionId: process.env.SESSION_ID || "d3kydHp_Queen-Anya_jMTE=",
